...
class AdvancedSnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if head == self.fruit_pos:
            ...
            # In the third experiment the program does not give rewards to help the AI find the food
            reward = -0.02  # Also the penalnty that is given to the AI every frame is higher than before
...
if __name__ == "__main__":
    EXP_NAME = "Exp_3_No_Distance_Reward_And_Higher_Penalty"
