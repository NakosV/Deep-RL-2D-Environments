    ...
    def step(self, action):
        ...
        if head == self.fruit_pos:
            ...
            if current_distance < self.prev_distance:
                ...
                reward = -0.1
            reward -= 0.01 # In the second experiment the program feeds the AI a negative reward for every frame it is alive
...
if __name__ == "__main__":
    EXP_NAME = "Exp_2_Distance_Reward_And_High_Penalty"
