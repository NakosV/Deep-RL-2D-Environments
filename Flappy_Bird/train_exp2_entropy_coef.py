...
class FlappyBirdEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward = 0  # The second experiment also doesn't feed the AI any rewards
        terminated = False
...
if __name__ == "__main__":
    ...
    # Here there has been an addition of a ent_coef which is how much the AI is encouraged to explore and try different things
    # Also unlike the fist experiment here the size of the Neural Network has been initialized though it is the same size as the first experiment
