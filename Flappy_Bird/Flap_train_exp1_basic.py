...
class FlappyBirdEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward = 0  # ΑΛΛΑΓΗ: Καμία ανταμοιβή επιβίωσης. Μόνο events.
        terminated = False
...
if __name__ == "__main__":
    ...
    # ΑΛΛΑΓΗ: Εντελώς default PPO. Αφαιρέθηκε το policy_kwargs και το ent_coef.
    model = PPO("MlpPolicy", train_env, verbose=1, device="auto")
