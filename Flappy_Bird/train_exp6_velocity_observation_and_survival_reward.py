...
class FlappyBirdEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        # We keep the new vision from the fifth experiment
    ...
    def step(self, action):
        ...
        reward = 0.1  # The sixth experiment feeds the AI a small positive reward for every frame it is alive
        terminated = False
...
if __name__ == "__main__":
    EXP_NAME = "Exp_6_Velocity_Observation_and_Survival_Reward"
