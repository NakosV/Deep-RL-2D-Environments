...
class FlappyBirdEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        # The AI can see the height of the bird, the distance of the next pipe the space of the hole at the next pipes and its velocity so now it has 4 inputs
    ...
    def step(self, action):
        ...
        reward = 0  # The fifth experiment doesn't feed the AI any rewards
        terminated = False
...
if __name__ == "__main__":
    EXP_NAME = "Exp_5_Velocity_Observation"
